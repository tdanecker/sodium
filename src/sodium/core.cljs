...
(def-simple-component dropdown-divider  sa/DropdownDivider  [:basic :dropdown-divider])
(def-simple-component dropdown-item     sa/DropdownItem     [:basic :dropdown-item])
(def-simple-component dropdown-menu     sa/DropdownMenu     [:basic])
...
(def-simple-component list-content      sa/ListContent      [:basic :list-content])
(def-simple-component list-description  sa/ListDescription  [:basic :list-description])
(def-simple-component list-header       sa/ListHeader       [:basic :list-header])
(def-simple-component list-icon         sa/ListIcon         [:basic :list-icon])
...
(def-simple-component message           sa/Message          [:basic :message])
